...
export const RestaurantHomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0d1217] text-slate-100 font-sans selection:bg-orange-500 selection:text-white">
      
      {/* Navigation Bar */}
      <nav className="sticky top-0 z-40 bg-[#131922]/90 border-b border-slate-800/80 backdrop-blur-xl px-6 py-4 shadow-2xl">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8 text-xs font-bold text-slate-300">
            <a href="#about" className="hover:text-orange-400 transition">Our Story</a>
            <a href="#signature" className="hover:text-orange-400 transition">Signature Dishes</a>
            <a href="#experience" className="hover:text-orange-400 transition">Ambiance</a>
            <a href="#contact" className="hover:text-orange-400 transition">Location & Hours</a>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="px-5 py-2.5 bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-400 hover:to-amber-500 text-white font-extrabold rounded-2xl text-xs shadow-lg shadow-orange-500/25 transition cursor-pointer flex items-center space-x-1.5"
            >
            ...
            <button
              ...
              className="p-2.5 bg-[#141a22] hover:bg-slate-900 border border-slate-800 text-slate-400 hover:text-white rounded-2xl transition cursor-pointer"
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#0d1217] via-[#0d1217]/70 to-transparent" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#0d1217] via-transparent to-[#0d1217]" />
        </div>

        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6">
          <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-orange-500/10 border border-orange-500/30 text-orange-400 text-xs font-black uppercase tracking-widest backdrop-blur-md">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <button
              onClick={() => navigate('/order')}
              className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-orange-500 via-amber-500 to-amber-600 hover:from-orange-400 hover:to-amber-500 text-white font-black text-sm rounded-2xl shadow-2xl shadow-orange-500/35 flex items-center justify-center space-x-3 transition transform hover:-translate-y-0.5 cursor-pointer"
            >
            ...
            <button
              onClick={() => setShowBookingModal(true)}
              className="w-full sm:w-auto px-8 py-4 bg-[#141a22]/90 hover:bg-slate-900 border border-slate-800 text-white font-extrabold text-sm rounded-2xl backdrop-blur-xl flex items-center justify-center space-x-2 transition cursor-pointer"
            >
          ...
          {/* Quick Info Badges */}
          <div className="pt-12 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto border-t border-slate-800/80">
            ...
            <div className="text-center">
              <div className="text-2xl font-black text-amber-400">Wood-Fired</div>
      ...
      <section id="signature" className="py-20 px-6 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-4">
          ...
          <button
            onClick={() => navigate('/order')}
            className="px-6 py-3 bg-[#141a22] hover:bg-slate-900 border border-slate-800 text-orange-400 font-extrabold text-xs rounded-2xl flex items-center space-x-2 transition cursor-pointer"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {featuredDishes.map(dish => (
            <div 
              key={dish.id}
              onClick={() => navigate('/order')}
              className="bg-[#141a22] border border-slate-800/80 rounded-3xl overflow-hidden shadow-xl hover:border-orange-500/40 transition transform hover:-translate-y-1.5 cursor-pointer flex flex-col justify-between group"
            >
              ...
              <div className="p-5 flex-1 flex flex-col justify-between">
                <div>
                  <h3 className="font-extrabold text-white text-base tracking-tight mb-1 group-hover:text-orange-400 transition">
                    {dish.name}
                  </h3>
                ...
                <div className="flex items-center justify-between text-xs pt-3 border-t border-slate-800">
                  ...
                  <span className="text-slate-400 font-bold">Order Online →</span>
                </div>
              </div>
            </div>
          ))}
      ...
      <section id="about" className="py-16 px-6 bg-[#141a22]/50 border-y border-slate-800/80">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              <div className="p-4 bg-[#0d1217] border border-slate-800 rounded-2xl space-y-1">
          ...
          <div className="relative">
            <img 
              ...
              className="rounded-3xl shadow-2xl border border-slate-800 object-cover w-full h-[400px]"
            />
            <div className="absolute -bottom-6 -left-6 bg-gradient-to-r from-orange-500 to-amber-600 p-6 rounded-3xl shadow-2xl text-white max-w-xs border border-orange-400/30">
      ...
      {/* Footer & Contact */}
      <footer id="contact" className="py-12 px-6 border-t border-slate-800/80 bg-[#0d1217] text-slate-400 text-xs">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center space-x-2 mb-3">
              <div className="w-8 h-8 rounded-xl bg-orange-500 text-white font-extrabold flex items-center justify-center">MC</div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><button onClick={() => navigate('/order')} className="hover:text-orange-400 transition">Online Self-Ordering</button></li>
              <li><button onClick={() => setShowBookingModal(true)} className="hover:text-orange-400 transition">Table Reservations</button></li>
              <li><button onClick={() => navigate('/login')} className="hover:text-orange-400 transition">Staff & POS Terminal</button></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <button
              onClick={() => navigate('/login')}
              className="px-4 py-2 bg-[#141a22] hover:bg-slate-900 border border-slate-800 text-orange-400 font-extrabold rounded-xl transition cursor-pointer"
            >
        ...
        <div className="max-w-7xl mx-auto border-t border-slate-800/80 pt-6 text-center text-[11px] text-slate-500">
      ...
      {showBookingModal && (
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="bg-[#141a22] border border-slate-800 rounded-3xl w-full max-w-md shadow-2xl p-6 relative">
            <button
              ...
              <form onSubmit={handleBookingSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-[#0d1217] border border-slate-800 rounded-2xl text-white text-xs focus:outline-none focus:border-orange-500"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2.5 bg-[#0d1217] border border-slate-800 rounded-2xl text-white text-xs focus:outline-none focus:border-orange-500"
                    >
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-400 hover:to-amber-500 text-white font-extrabold rounded-2xl text-xs shadow-xl shadow-orange-500/25 transition cursor-pointer"
                >
